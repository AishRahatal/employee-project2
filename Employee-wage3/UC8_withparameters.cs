...
{
    class UC8_withparameters
    {
        public const int is_parttime = 1;

        public const int is_fulltime = 2;
        public const int emp_rateperhour = 0;
        public const int num_workingdays = 0;
        public const int max_hours = 0;
        public  int wage_withparams(string company, int emp_rateperhour, int num_workingdays, int max_hours)
        {
            int emphrs = 0;
            int empwage = 0;
            int totalemphrs = 0;
